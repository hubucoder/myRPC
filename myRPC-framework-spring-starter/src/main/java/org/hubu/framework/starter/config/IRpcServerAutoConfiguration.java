package org.hubu.framework.starter.config;

import org.hubu.framework.core.common.event.IRpcListenerLoader;
import org.hubu.framework.core.server.ApplicationShutdownHook;
import org.hubu.framework.core.server.Server;
import org.hubu.framework.core.server.ServiceWrapper;
import org.hubu.framework.starter.common.IRpcService;
...
public class IRpcServerAutoConfiguration implements InitializingBean, ApplicationContextAware {
    ...
    private void printBanner(){
        System.out.println();
        System.out.println("==============================================");
        System.out.println("|||---------- myRpc Starting Now! ----------|||");
        System.out.println("==============================================");
