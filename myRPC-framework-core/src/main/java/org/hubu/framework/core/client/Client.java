...
public class Client {
    ...
    public RpcReference initClientApplication() throws InterruptedException, InstantiationException, IllegalAccessException, IOException, ClassNotFoundException {
        ...
        // 注册 ServiceUpdateListener，就是把该类加入 IRpcListenerLoader 的 map 集合
